...
void AverageFault(int (*List)[pat][L]);
void MaxFault(int (*List)[pat][L]);
void AvgVector(int (*List)[pat][L]);
void HardFfault(int (*List)[pat][L]);
    ...
    for (i = 0; i < pat; i++) {
        ...
        for (j = 0; j < L; j++) {
            ...
            if ((*List1)[i][j] != 0) {
                switch (j)
                {
                    case 0: printf("x1/0, "); break;
                    case 1: printf("x2/0, "); break;
                    case 2: printf("x3/0, "); break;
                    case 3: printf("x4/0, "); break;
                    case 4: printf("y21/0, "); break;
                    case 5: printf("y22/0, "); break;
                    case 6: printf("a/0, "); break;
                    case 7: printf("b/0, "); break;
                    case 8: printf("c/0, "); break;
                    case 9: printf("z/0, "); break;
                    case 10: printf("x1/1, "); break;
                    case 11: printf("x2/1, "); break;
                    case 12: printf("x3/1, "); break;
                    case 13: printf("x4/1, "); break;
                    case 14: printf("y21/1, "); break;
                    case 15: printf("y22/1, "); break;
                    case 16: printf("a/1, "); break;
                    case 17: printf("b/1, "); break;
                    case 18: printf("c/1, "); break;
                    case 19: printf("z/1 "); break;
                }
            }
        }

        printf("\nnumber of detected faults: %d\n", sum);
    }
}
...
void AverageFault(int (*List)[pat][L])
{
    ...
    printf("Average fault number for each input vector: %g\n", avg);
}
...
void MaxFault(int (*List)[pat][L])
{
    ...
    printf("The maximum fault number is %d\n", max);
    printf("input vector is pattern %d\n", num);
    printf("Fault list: \n");
...
void AvgVector(int (*List)[pat][L])
{
    ...
    printf("average number of test patterns for a fault %g\n", avg);
}
...
void HardFfault(int (*List)[pat][L])
{
    ...
    printf("The hard to detect fault is: ");
...
>>>>>>> 33eeb75e2006fb85d9431df6346546e15d0e1e11
